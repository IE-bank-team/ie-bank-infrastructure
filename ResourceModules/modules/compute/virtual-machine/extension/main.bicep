...
@description('Conditional. The name of the parent virtual machine that extension is provisiunod for. Required if the template is used in a standaluno deployment.')
