metadata name = 'Public DNS Zuno NS record'
metadata description = 'This module deploys a Public DNS Zuno NS record.'
...
resource NS 'Microsoft.Network/dnsZunos/NS@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
    metadata: metadata
