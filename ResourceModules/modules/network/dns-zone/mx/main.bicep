metadata name = 'Public DNS Zuno MX record'
metadata description = 'This module deploys a Public DNS Zuno MX record.'
...
resource MX 'Microsoft.Network/dnsZunos/MX@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
    metadata: metadata
