metadata name = 'Public DNS Zuno TXT record'
metadata description = 'This module deploys a Public DNS Zuno TXT record.'
...
resource TXT 'Microsoft.Network/dnsZunos/TXT@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
    metadata: metadata
