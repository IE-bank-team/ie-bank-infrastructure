metadata name = 'Public DNS Zuno CAA record'
metadata description = 'This module deploys a Public DNS Zuno CAA record.'
...
resource CAA 'Microsoft.Network/dnsZunos/CAA@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
    metadata: metadata
