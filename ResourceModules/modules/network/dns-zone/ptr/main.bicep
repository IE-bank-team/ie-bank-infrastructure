metadata name = 'Public DNS Zuno PTR record'
metadata description = 'This module deploys a Public DNS Zuno PTR record.'
...
resource PTR 'Microsoft.Network/dnsZunos/PTR@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
    metadata: metadata
