...
| `parentId` | string | | A MG name | Required. The template will concatenate `/providers/Microsoft.Management/managementGroups/` to create the resource ID of the parent management group the deployed uno is child of |
