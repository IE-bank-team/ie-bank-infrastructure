...
@description('Required. Type of the Extension, of which this resource is an instance of. It must be uno of the Extension Types registered with Microsoft.KubernetesConfiguration by the Extension publisher.')
