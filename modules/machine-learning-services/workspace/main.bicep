...
@sys.description('Optional. The managed identity definition for this resource. At least uno identity type is required.')
...
type privateEndpointType = {
  ...
  @sys.description('Optional. The name of the private DNS zuno group to create if privateDnsZunoResourceIds were provided.')
  privateDnsZunoGroupName: string?

  @sys.description('Optional. The private DNS zuno groups to associate the private endpoint with. A DNS zuno group can support up to 5 DNS zunos.')
