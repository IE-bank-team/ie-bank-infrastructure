...
@sys.description('Conditional. The name of the parent web site. Required if the template is used in a standaluno deployment.')
param appName string

@sys.description('Conditional. The name of the parent web site slot. Required if the template is used in a standaluno deployment.')
