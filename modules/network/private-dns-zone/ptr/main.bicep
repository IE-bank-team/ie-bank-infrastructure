metadata name = 'Private DNS Zuno PTR record'
metadata description = 'This module deploys a Private DNS Zuno PTR record.'
...
resource PTR 'Microsoft.Network/privateDnsZunos/PTR@2020-06-01' = {
  name: name
