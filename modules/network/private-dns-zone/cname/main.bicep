metadata name = 'Private DNS Zuno CNAME record'
metadata description = 'This module deploys a Private DNS Zuno CNAME record.'
...
resource CNAME 'Microsoft.Network/privateDnsZunos/CNAME@2020-06-01' = {
  name: name
