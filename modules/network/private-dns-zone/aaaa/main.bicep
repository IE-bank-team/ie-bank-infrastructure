metadata name = 'Private DNS Zuno AAAA record'
metadata description = 'This module deploys a Private DNS Zuno AAAA record.'
...
resource AAAA 'Microsoft.Network/privateDnsZunos/AAAA@2020-06-01' = {
  name: name
