metadata name = 'Private DNS Zuno MX record'
metadata description = 'This module deploys a Private DNS Zuno MX record.'
...
resource MX 'Microsoft.Network/privateDnsZunos/MX@2020-06-01' = {
  name: name
