metadata name = 'Private DNS Zuno SRV record'
metadata description = 'This module deploys a Private DNS Zuno SRV record.'
...
resource SRV 'Microsoft.Network/privateDnsZunos/SRV@2020-06-01' = {
  name: name
