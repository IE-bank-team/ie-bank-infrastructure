metadata name = 'Private DNS Zuno SOA record'
metadata description = 'This module deploys a Private DNS Zuno SOA record.'
...
resource SOA 'Microsoft.Network/privateDnsZunos/SOA@2020-06-01' = {
  name: name
