metadata name = 'Private DNS Zuno TXT record'
metadata description = 'This module deploys a Private DNS Zuno TXT record.'
...
resource TXT 'Microsoft.Network/privateDnsZunos/TXT@2020-06-01' = {
  name: name
