metadata name = 'Private DNS Zuno A record'
metadata description = 'This module deploys a Private DNS Zuno A record.'
...
resource A 'Microsoft.Network/privateDnsZunos/A@2020-06-01' = {
  name: name
