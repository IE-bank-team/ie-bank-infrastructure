metadata name = 'Public DNS Zuno A record'
metadata description = 'This module deploys a Public DNS Zuno A record.'
...
resource A 'Microsoft.Network/dnsZunos/A@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
