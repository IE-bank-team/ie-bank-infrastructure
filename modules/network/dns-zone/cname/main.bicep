metadata name = 'Public DNS Zuno CNAME record'
metadata description = 'This module deploys a Public DNS Zuno CNAME record.'
metadata owner = 'Azure/module-maintainers'

@description('Conditional. The name of the parent DNS zuno. Required if the template is used in a standaluno deployment.')
...
resource dnsZuno 'Microsoft.Network/dnsZunos@2018-05-01' existing = {
  name: dnsZunoName
}

resource CNAME 'Microsoft.Network/dnsZunos/CNAME@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
