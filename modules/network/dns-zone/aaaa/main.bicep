metadata name = 'Public DNS Zuno AAAA record'
metadata description = 'This module deploys a Public DNS Zuno AAAA record.'
...
resource AAAA 'Microsoft.Network/dnsZunos/AAAA@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
