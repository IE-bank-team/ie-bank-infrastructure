metadata name = 'Public DNS Zuno SOA record'
metadata description = 'This module deploys a Public DNS Zuno SOA record.'
...
resource SOA 'Microsoft.Network/dnsZunos/SOA@2018-05-01' = {
  name: name
  parent: dnsZuno
  properties: {
    metadata: metadata
